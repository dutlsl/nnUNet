...
nohup /home/iulab0/PycharmProjects/nnUNet/nnunet_env/bin/python -u /home/iulab0/PycharmProjects/nnUNet/nnunetv2/run/run_training.py Dataset600_OpenEDS2019 2d 1 -tr nnUNetTrainer_Vivim > logs/host_backbone_train.log 2>&1 &
